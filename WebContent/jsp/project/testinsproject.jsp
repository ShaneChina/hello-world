...
<script type="text/javascript" src="/HelloWeb/js/project/js_insproject.js"></script>
<script type="text/javascript" src="/HelloWeb/js/project/js_insprojectres.js"></script>
...
<!-- 			<tr>
				<td>创建人:</td>
				<td><input type="text" name="create_id" id="create_id" value=""></td>
			</tr> -->
			<tr>
				<td>创建人:</td>
...
<!-- 			<tr>
				<td>创建时间:</td>
				<td><input type="text" name="create_time" id="create_time" value=""></td>
			</tr> -->
			<tr>
				<td>创建时间:</td>
			...
			<tr>
				<td>状态:</td>
				<td><div id="status">P</div></td>
			</tr>
			<tr>
				<td><input type="button" value="新增" id="insbtnid"></td>
				<td><input type="button" value="返回" id="insbackbtnid"></td>
			</tr>
		</table>
	</form>
