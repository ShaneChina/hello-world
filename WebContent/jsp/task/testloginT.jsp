...
<html>
	<head>
		...
		<script charset="UTF-8" type="text/javascript" src="/HelloWeb/js/task/js_logincheckT.js"></script>
		<script charset="UTF-8" type="text/javascript" src="/HelloWeb/js/task/js_loginT.js"></script>
